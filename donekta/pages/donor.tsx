      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center max-w-md w-full">
          ...
          <p className="text-gray-500 text-sm leading-relaxed mb-6">
            ...
            <strong>{selected.name}</strong> fue procesada exitosamente. Recibirás un comprobante en tu correo.
          </p>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-8">
                ...
                <div className="flex items-center gap-4 text-sm text-gray-400 mb-4">
                  <span className="flex items-center gap-1"><MapPin className="w-3.5 h-3.5" />{selected.city}, {selected.state}</span>
                  {selected.beneficiaries && <span className="flex items-center gap-1"><Users className="w-3.5 h-3.5" />{selected.beneficiaries}</span>}
                </div>
                {selected.mission && <p className="text-gray-600 text-sm leading-relaxed mb-6">{selected.mission}</p>}
